        ...
        public static void Choice1()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (input == "a")
                    {
                        Console.WriteLine("Your boat came together pretty quickly, but you didn't think about how long it would stay afloat... You make it to open waters and your boat sinks. You're dead.");
                        Console.WriteLine("Better luck next time!");
                        Environment.Exit(0);                  
                    }
                    else
